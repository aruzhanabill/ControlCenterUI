...
export const fsStateRecordSchema = z.object({
  ...
  state: fsStateSchema,
  gn2_drain: z.boolean().default(false),
  gn2_fill: z.boolean().default(false),
  lox_fill: z.boolean().default(false),
  lox_disconnect: z.boolean().default(false),
  depress: z.boolean().default(false),
  press_pilot: z.boolean().default(false),
  run: z.boolean().default(false),
  igniter: z.boolean().default(false),
  ereg_power: z.boolean().default(false),
...
export const fsLoxGn2TransducersRecordSchema = z.object({
  ...
  pilot_pres: z.number(),
  qd_pres: z.number(),
  ereg_closed: z.boolean().default(false),
  ereg_stage_1: z.boolean().default(false),
  ereg_stage_2: z.boolean().default(false),
...
export const radioGroundRecordSchema = z.object({
  ...
  gps_fix: z.boolean().default(false),
